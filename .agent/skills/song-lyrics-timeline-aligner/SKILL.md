...
9. Final title is exactly the profile's song-title format (default profile: `【李豆沙】豆沙歌，《canonical歌名》`); cover text is exactly `《歌名》`.
...
11. Keep `upload_allowed=false` unless 维护者 separately authorizes this exact artifact. If authorized, use the

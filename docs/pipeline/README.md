...
| 30 | [30-boundary.md](30-boundary.md) | 双层语义边界：source full-window 见证、resolver 与 final-delivery 重审 | `src/autoslice/boundary_resolver.py`、`boundary_semantic_review.py`、`producer_boundary_review_stage.py`、`producer_boundary_resolution.py`、`producer_boundary_owner_contract.py`、`private_boundary_package.py` |

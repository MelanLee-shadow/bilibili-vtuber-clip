...
| 新闻/社区 crawler | 官方成员源、B 站切片 metadata 与有限评论、ACG 新闻源 | 低频官方名册 + 每日时效词/社区称呼/话题图 | 官方成员只低频校验；新闻和新出现的昵称、粉丝名、事件梗每天增量抓取并累积证据；CPA 负责关系语义分类，确定性证据门负责接受，版本化人工裁定只纠正已发现关系而不制造证据；社区词不冒充官方词面也不直接改字幕 |

"""Offline probe: restatement-pair landscape over the harvest.

Runs the restatement detector wide-open (low thresholds) over the pristine
machine transcripts of the five 维护者-reviewed candidates, classifies every
detected pair against the 维护者-speaker-truth-diff.v2 artifacts, and prints a
...
def main() -> int:
    ...
    parser.add_argument(
        "--truth-root",
        type=Path,
        default=Path("reports/reviewer_truth_harvest/2026-08-07"),
    )

...
Ivan 2026-08-18 逐字：「我刚刚看了一眼11号的切片，立刻发现一个严重问题，那就是
...
写着 2026-07-25 教训：“main lane 不会因为指纹变化自动重新 supersede 一条已经
...
的判据，纯审计）：写明 schema_version、Ivan 逐字授权与时间戳、重做原因
...
用法：
  python3 scripts/requeue_review_ready_for_speaker_rerender.py \
      ...
      --authority-timestamp 2026-08-18T00:00:00Z \
      [--apply]
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        ...
        "scripts/free_session_autoslice.py:list_dates() only processes the "

...
# com.ivan.lidousha-slice-monitor every 5 minutes.
export PATH="/opt/homebrew/bin:/usr/bin:/bin:/usr/sbin:/sbin"
PROJ="/Users/ivan/Project/vtuber-slice"
cd "$PROJ" || exit 1
...
/opt/homebrew/bin/python3 "$PROJ/scripts/lidousha_slice_monitor.py" >> "$LOG" 2>&1

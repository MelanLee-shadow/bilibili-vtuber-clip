...
This is the standard "圈中候选→出成品" driver (维护者). Its core
...
SELF-REPAIR loop (维护者: flags move the cut to the next verifiably
...
Spec JSON:
{
  ...
  "given_title": null,                      # 维护者-given title is verbatim-final
  "lead_pad_ms": 300,

...
full-cue, single-speaker HOST rows from an Ivan-reviewed speaker override;
        ...
        selected.append(
            {
                ...
                "authority": authority,
                "speaker": speaker,
                # The pristine worksheet binding and Ivan's corrected text may
...
def build_reviewed_enrollment(
    *,
    ...
    if not candidate_id or "ivan_reviewed" not in status:
        raise ReviewedEnrollmentError("override is not an Ivan-reviewed candidate truth")

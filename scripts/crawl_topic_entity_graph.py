...
def parser() -> argparse.ArgumentParser:
    ...
    result.add_argument("--max-requests", type=int, default=48)
    ...
    result.add_argument("--max-topics", type=int, default=6)
    result.add_argument("--max-queries", type=int, default=12)
    result.add_argument("--max-works-per-topic", type=int, default=4)

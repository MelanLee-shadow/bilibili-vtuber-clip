...
def _run_live_source(
    *,
    ...
    # lateness bias (fix) that a fresh independent ASR timeline
    # does not share.
    ...
    evidence = apply_style_profile(evidence, _default_style_profile(), title=title, duration_seconds=duration_seconds)
...
from src.autoslice.publish_staging import (
    ...
    _stage_ai_cover as _stage_ai_cover_impl,
...
def _stage_ai_cover(
    ...
    *,
    ...
    return _stage_ai_cover_impl(
        ...
        final_host_identity_verifier=verify_final_host_identity,

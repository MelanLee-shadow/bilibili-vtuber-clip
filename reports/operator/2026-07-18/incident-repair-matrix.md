...
- 另外 3 个也已检查：`auto_155648_152_178` 从未发布；
...
|---|---|---:|---|
| `auto_155648_152_178` | 从未发布、非 current delivery | 0 | 已检查，不制造新的 current 交付 |
| `auto_162645_712_787` | 被 `auto_162645_712_967` 覆盖 | 0 | 记录检查结果，不重复烧录短版 |
| `auto_162645_938_967` | 被 `auto_162645_712_967` 覆盖 | 0 | 记录检查结果，不重复烧录短版 |

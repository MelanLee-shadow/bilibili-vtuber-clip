...
whose text/timing came from an Ivan-reviewed baseline diff, but until this
...
overwrite already-correct, Ivan-reviewed text with its own transcription —
the zsm8 shape (2026-08-08): baseline-applied cues 52/58/59 rewritten away
from Ivan's verified transcript, caught only by the later, separate final
...
silent drop. (Ivan 2026-08-08 配额上传波修复.)
"""

...
consumes one committed 维护者 response to rebind the already-reviewed delivery
...
def _expected_authority() -> dict[str, object]:
    return {
        ...
        "line947_c3_authority": {
            "authority": "维护者/Claude line947 exhaustive C3 ruling",
...
def derive_current_boundary_review(
    *,
    ...
    result.update({
        ...
        "reason_codes": ["C3_REVIEWER_AUTHORIZED_BOUNDARY_REBIND"],
    })
    return result

...
Extracted from the runner (god-file decomposition) after the 2026-08-09
...
mount.  On 2026-08-09 a genuine 11:03Z→14:38Z session first materialised .mp4
...
def sustained_missing_recording_warning(
    ...
    *,
    ...
    because the cloud mount lags: on 2026-08-09 the day directory for an 11:03Z

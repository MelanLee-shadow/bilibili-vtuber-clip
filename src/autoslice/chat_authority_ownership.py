...
already-verbatim chat text — the 2026-08-11 主包/主播 shape: cue 1:12 of
...
typo. Ivan 2026-08-19 ruling #2: 「弹幕会有梗，有刻意的错写，因此只要识别出是
弹幕就不应该改」.

This is the same architecture gap ``redelivery_baseline_ownership.py`` closed
for Ivan-reviewed baseline diffs (2026-08-08 zsm8 case) — a second, different

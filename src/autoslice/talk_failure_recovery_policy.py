...
def subtitle_authority_recovery_relatives(
    ...
    return (
        ...
        "src/autoslice/delivery_fast_path.py",
        ...
        "src/autoslice/final_review_discovery_prompt.py",
        "src/autoslice/final_review_witness_dispatch.py",
        ...
        "src/autoslice/native_foreign_witness.py",
        "src/autoslice/local_asr_target_evidence.py",
        "src/autoslice/subtitle_audio_evidence.py",
        "src/autoslice/supplement_audio_budget.py",

...
def _register_final_source_language_cpa_repairs(
    chat_authority_audit: dict[str, Any],
    *,
    input_srt: str,
    output_srt: str,
    ...
    """Register late CPA language repairs as final-surface owners.

    Source-language preservation runs after ordinary context adjudication.  If
    it changes the same exact cue again, the older CPA surface must be retired
    through an auditable same-window before->after chain; otherwise package
    finalization incorrectly requires both mutually exclusive texts.
    """
...
def _finalize_text_evidence(
    *,
    ...
    if padded is not None:
        ...
        source_language_input_srt = srt_text
        ...
        _register_final_source_language_cpa_repairs(
            chat_authority_audit,
            input_srt=source_language_input_srt,
            output_srt=srt_text,

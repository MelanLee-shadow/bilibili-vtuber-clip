...
def validate_manual_title_keep_authority_document(
    ...
    维护者 = _mapping(
        ...
        label="reviewer_authority",
    )
    _validate_quote(维护者["title_delta_approval"], label="title_delta_approval")
    _validate_quote(维护者["publication_release"], label="publication_release")

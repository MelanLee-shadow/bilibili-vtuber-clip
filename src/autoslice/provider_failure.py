...
事故（8/7 四条复活件同批 `provider_transient` 全灭）暴露两个缺口：
...
_SERVICE_MARKERS = (
    ...
    "auth_unavailable",
    "no auth available",
    # CPA 上游 sudocode 的分组路由抽签（维护者 裁定 #8：一个分组带

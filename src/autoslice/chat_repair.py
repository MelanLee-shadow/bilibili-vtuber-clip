...
def reconcile_contradictory_entity_repairs(
    ...
    the same speech (恋死/恋青/练死 case: "clearly lian qing twice"
...
def _aligned_span_replacements(
    ...
    *,
    ...
    speech around it (乐队番实案：整段覆盖把主播自己的「算什么」
    ...
    # 多出 ≥2 字，那是她念读中途的插话（「谢谢你」等，伊依 SC 实案）
...
def _apply_gift_name_repairs(
    ...
    *,
    ...
    案例：她念读被 ASR 听成「谢谢有人看到你的人鱼」，结构化事件里

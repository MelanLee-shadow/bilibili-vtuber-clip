...
DROP_AUTHORITY = "REVIEWER_2026-08-10_UNREADABLE_SPAN_DELETE_AND_PARK"
...
MACHINE_UNDECIDED_WITNESS_REASON_CODES = frozenset(
    {
        ...
        "EXACT_SOURCE_TRANSCRIPT_PROVIDER_ROUTE_INVALID",
        "EXACT_SOURCE_TRANSCRIPT_REPORT_INVALID",
        "EXACT_SOURCE_TRANSCRIPT_REQUEST_INVALID",

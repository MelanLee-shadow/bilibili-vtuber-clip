...
def validate_qixi_cue21_diagnostic_evidence(
    ...
    *,
    ...
    if not isinstance(document, Mapping) or set(document) != expected or document.get("schema_version") != SCHEMA or document.get("status") != "UNRESOLVED_NO_RELEASE_TEXT" or document.get("release_decision") != "NO_INTERSECTION; IVAN_EXACT_TEXT_REQUIRED":

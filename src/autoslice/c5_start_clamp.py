...
C5_ACCEPTANCE_EXPECTATIONS = AcceptanceExpectations(
    ...
    decision_basis="Root accepted the exact C5 cue-5 private start-clamp proposal after verifying that the frozen 9750 ms boundary lies inside the detected silence interval and that 维护者's named C5 content change remains limited to dropping humming cues 13-15; private projection only, with no text, speaker, title, cover, boundary, media, deploy, manifest, or upload approval.",
)

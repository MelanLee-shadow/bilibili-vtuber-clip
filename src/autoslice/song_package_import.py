...
* 交付物是 ``build_song_review_manifest.v1`` 压平改名后的**评审包**：
...
SONG_REVIEW_MANIFEST_GENERATOR = "build_song_review_manifest.v1"
...
# 必须与 ``build_song_review_manifest.REQUIRED_ROLES`` 逐字一致：那是
...
# ``build_daily_review_manifest``；歌切的评审 manifest 在 free 上永远

...
def flatten_and_audit_private_replay(
    ...
    from scripts.audit_review_package import AUDIT_POLICY_EPOCH, audit_package
...
def build_replay_after_image(
    ...
    from src.autoslice.reviewed_baseline_replay_after_image import (
        build_replay_after_image as _build_replay_after_image,
    )
    return _build_replay_after_image(

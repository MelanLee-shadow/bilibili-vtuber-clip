...
2026-08-10 (`song_210131_1210` /《心型病毒》联唱案).  The v5 audio-observation
...
def witness_post_song_talk_start(
    *,
    ...
    millisecond (14 reports, 2026-07-10 → 2026-08-08): the nearest transcribed
    ...
    policy call for Ivan, not a side effect of this fix.  Production is not

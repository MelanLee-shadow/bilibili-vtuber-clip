...
RECORD_PATH_POINTERS: frozenset[JsonPointer] = frozenset(
    {
        ...
        ("subtitle_ass_path",),
        # Capture locators move with the package; the hashed receipt does not.
        ("subtitle_audio_correspondence", "output_dir"),
        ("subtitle_audio_correspondence", "witness_srt_path"),
        ("subtitle_audio_correspondence", "provenance_path"),
        ("subtitle_audio_correspondence", "correspondence_path"),
        ("subtitle_audio_correspondence", "raw_result_path"),

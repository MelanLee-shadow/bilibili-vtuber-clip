...
The only permitted input is the exact C9 direct 维护者 authority plus its two
...
AUTHORITY_NAME = f"{CID}.维护者-direct-title-cover-authority.v1.json"
...
AUTHORITY_SCHEMA = "fastlane-c9-维护者-direct-title-cover-authority.v1"

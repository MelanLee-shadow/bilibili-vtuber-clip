"""Ivan 2026-08-08 Wave 8 F2/F7 pristine-machine canaries."""
...
def test_f2_pristine_machine_occurrences_receive_complete_candidate_receipt():
    ...
    assert "Ivan 2026-07-10" in prompts[0]
...
@pytest.mark.parametrize(
    ("machine_current", "machine_attempted", "ivan_truth", "current_is_truth"),
    [
        ("油菜", "太菜", "由菜", False),
        ("家人们", "家人", "家人们", True),
    ],
...
def test_f7_pristine_context_rewrite_without_acoustic_witness_is_disclosure_only(
    ...
    # Ivan truth is deliberately only a post-execution comparison assertion.
    assert (machine_current == ivan_truth) is current_is_truth

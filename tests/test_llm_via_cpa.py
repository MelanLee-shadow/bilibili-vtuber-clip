...
def test_default_chain_is_sol_without_gpt5_downgrade(tmp_path):
    """No env/argv override: GPT-6 Sol, three bounded attempts, no old-model downgrade."""

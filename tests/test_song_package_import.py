...
源包用**真正的评审包 builder** 现造（``tests.test_build_song_review_manifest``
...
from tests.test_build_song_review_manifest import (
    BASENAME,
    CANDIDATE_ID,
    _build,
    _fixture,
        ...
        json.dumps(
            {
                ...
                "passed": True,
                "root": "/home/维护者/Project/vtuber-reproduce/wsl-song-88/"
...
def _stub_apply_gates(
    ...
    import scripts.build_song_review_manifest as song_builder

...
def _build_daily_talk_package(
    ...
    *,
    ...
    ``auto_220747_488_680`` (provisional-upload blocked report):
...
def test_atomic_projection_failure_preserves_previous_package_bytes(
    ...
    monkeypatch.setattr(
        "scripts.build_daily_review_manifest.os.replace",
        fail_replace,
    )
...
def test_build_accepts_publication_closure_batch_statuses(
    ...
    unreviewable (``ready_unpublished_with_failures`` refusal).
    """

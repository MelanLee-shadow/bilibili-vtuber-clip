...
def test_reviewed_speaker_overrides_bind_stable_text_final_not_ephemeral_auto_labels(tmp_path: Path) -> None:
    import hashlib
    ...
    assert "[连线] 结果还是聋人啊" in output_srt.read_text(encoding="utf-8")

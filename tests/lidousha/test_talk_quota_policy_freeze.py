...
放宽了——四条 89.0 / 87.25 / 86.75 / 86.0 在 维护者 8/7 原定的 90 门下一条都进
不来，在 85 门下四条全进。

维护者（逐字）:「追认。88改成15，85。日常还是5，并没有分数限制。」
...
def _game_entry(cap: int, gate: float | None, *, entry_id: str = "canary-2026-08-07") -> dict:
    return {
        ...
        "authority": "canary: 维护者 2026-08-07 10 席 + 2026-08-10 追认门 85",
    }
...
def test_canary_two_global_constants_cannot_rewrite_a_dated_verdict(
    ...
    The constants survive only as the historical anchor of 维护者's 
...
def test_repo_constants_are_reviewers_2026_08_07_wording() -> None:

"""语义路径 OR 聚合 v2 的对抗性回归（ChatGPT Pro 2026-08-10 §二末表逐条）。

设计权威：`docs/reviews/2026-08-10-or-gate-metric-and-function-split.md`
真值权威：`docs/reviews/2026-08-10-ivan-blind-review-tier1-ground-truth.md`
...
# --------------------------------------------------------------------------
# Ivan 2026-08-10 第 3 条：说话人存疑 → 直接人工审阅
# --------------------------------------------------------------------------
...
# Ivan 2026-08-10 盲审真值 + free 上的真实维度分/惩罚，逐条照抄，未做任何拟合。
REAL_TIER1 = {
...
def test_real_tier1_cards_have_no_verified_level_four(candidate_id: str):
    ...
    ⚠️ 因此这四条**全部**落回综合路径——本用例不演示 Ivan 的排序，排序分离要等

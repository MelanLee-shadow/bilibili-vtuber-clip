...
def test_default_profile_jingting_prompt_matches_authoritative_glossary_fingerprint():
    ...
    # 2026-07-27b：白色奶龙梗一族入 glossary（白/粉/黑奶龙、礼小虎、动捕房、
    # 做面部、星汐误听面新C；误听面=2026-07-24/25 bcut 实测，保向不盲替）。
    assert hashlib.sha256(prompt.encode()).hexdigest() == (
        "afbec46a1e3c22918be0109e173ad326ed7a276ace01a9b40aa34afe82fa52a5"
    )

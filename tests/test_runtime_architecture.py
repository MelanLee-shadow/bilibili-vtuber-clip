...
FUNCTION_DEBT_LEDGER = {
    ("scripts/audit_review_package.py", "_audit_item_story_contract"): 316,
    ...
    ("scripts/audit_review_package.py", "audit_package"): 349,
    ("scripts/build_recovery_review_manifest.py", "build_manifest"): 365,
    ...
    ("src/autoslice/publish_staging.py", "_stage_ai_cover"): 418,
